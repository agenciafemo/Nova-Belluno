...
export const services: Service[] = [
  {
    ...
    related: ['enfermeiro-chefe', 'tecnicos-enfermagem', 'nutricao'],
  },
  {
    number: '02',
    slug: 'enfermeiro-chefe',
    area: 'Enfermagem',
    title: 'Enfermeiro-chefe',
    ...
    imageWidth: 960,
    imageHeight: 1200,
    whatsappMessage: 'Olá! Gostaria de saber mais sobre Enfermeiro-chefe na Nova Belluno.',
    metaTitle: 'Enfermeiro-chefe | Nova Belluno',
    metaDescription: 'Conheça o papel do enfermeiro-chefe na coordenação da assistência, na orientação da equipe e no cuidado integrado da Nova Belluno.',
    introduction: 'O enfermeiro-chefe contribui para organizar a assistência de enfermagem e conectar informações importantes da rotina. Seu trabalho envolve acompanhamento, orientação da equipe e articulação com outros profissionais conforme as necessidades de cada residente.',
    sections: [
      {
        ...
        paragraphs: [
          ...
          'As decisões e os encaminhamentos dependem da avaliação profissional e das necessidades percebidas. O enfermeiro-chefe também pode contribuir para orientar a equipe diante de mudanças na rotina.',
        ],
      },
      {
    ...
    faq: [
      { question: 'Qual é o papel do enfermeiro-chefe?', answer: 'Ele coordena a assistência de enfermagem, acompanha os cuidados e orienta a equipe de acordo com as necessidades observadas.' },
      { question: 'O enfermeiro-chefe substitui a avaliação médica?', answer: 'Não. Enfermagem e avaliação médica possuem responsabilidades diferentes e podem atuar de forma integrada dentro do plano de cuidado.' },
  ...
  },
  {
    ...
    related: ['enfermeiro-chefe', 'avaliacao-medica', 'nutricao'],
  },
  {
    number: '04',
    slug: 'nutricao',
